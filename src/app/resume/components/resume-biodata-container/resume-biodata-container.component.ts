...
import { ResumeBiodataModel, ResumeBiodataAssetsModel } from '@resume/models/resume-biodata.model'
...
@Component({
  ...
  template: `<app-resume-biodata [assets] = "assets$ | async"
                               [biodata] = "biodata$ | async"></app-resume-biodata>`
})
